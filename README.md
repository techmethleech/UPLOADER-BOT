...
**Heroku Buildpacks**
```
https://github.com/techmethleech/UPLOADER-BOT/heroku-buildpack-ffmpeg-latest
```
```
heroku/python
```
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://github.com/techmethleech/UPLOADER-BOT/issues/14#issuecomment-1021253536)
